...
// and that the sheet's copy keeps both halves of the ask — set a name the club
// will recognise, and the (affectionate) threat for anyone who doesn't.
...
describe("the amnesty copy", () => {
  it("asks for a recognisable name and warns what a fake one costs", () => {
    expect(NAME_RESET_MESSAGE).toContain("has been reset");
    expect(NAME_RESET_MESSAGE).toContain("will recognise");
    expect(NAME_RESET_MESSAGE).toContain("nickname");
